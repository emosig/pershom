...
class Monomial:
    ...
    #Funzione che calcola il prodotto di lui con un'altro Monomial
    #PRENDE SOLTANTO IL SHIFT DELLA PRIMA FUNZIONE
    def times(self,m):
        r,a,b,c,d = m.get_coeffs()
        return Monomial(r*self.r,a+self.a,b+self.b,c+self.c,d+self.d,self.shift_a,self.shift_b,self.shift_c,self.shift_d,self.molt_a,self.molt_b,self.molt_c,self.molt_d)
